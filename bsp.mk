...
#
# \brief
# Define the KIT_XMC12_BOOT_001 target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC1200-T038x0200
DEVICE:=XMC1200-T038x0200
DEVICE_COMPONENTS:=CAT3 XMC12XX
DEVICE_LIST:=XMC1200-T038x0200
DEVICE_TOOL_IDS:=bsp-assistant device-configurator library-manager memory-analyzer online-simulator project-creator
DEVICE_XMC1200-T038x0200_CORES:=CORE_NAME_CM0_0
DEVICE_XMC1200-T038x0200_DIE:=XMC1200
DEVICE_XMC1200-T038x0200_FLASH_KB:=200
DEVICE_XMC1200-T038x0200_SRAM_KB:=16
